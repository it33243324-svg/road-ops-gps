...
const facilityStyle=`.facility{position:relative;white-space:nowrap;transform:translate(-7px,-7px);font-weight:900;font-size:10px;line-height:14px;filter:drop-shadow(0 2px 3px #000a)}.facility .dot{display:inline-flex;width:14px;height:14px;border-radius:50%;align-items:center;justify-content:center;border:2px solid #fff;color:#fff;font-size:7px;vertical-align:middle;box-sizing:border-box;background:var(--fc)}.facility .fname{display:inline-block;margin-left:3px;padding:2px 5px;border-radius:5px;background:#07171de8;border:1px solid var(--fc);color:#fff;vertical-align:middle}.facility.ic{--fc:#00b7ff}.facility.jct{--fc:#d96cff}.facility.sa{--fc:#35d07f}.facility.pa{--fc:#ffb23f}.facility.sic{--fc:#00d5d5}@media(max-width:600px){.facility{font-size:9px}.facility .fname{padding:1px 4px}}`;
